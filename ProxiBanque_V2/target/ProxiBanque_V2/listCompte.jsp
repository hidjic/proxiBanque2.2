		...
		<table class="table">
		  ...
		  <tbody>
		    ...
		    <tr>
		      ...
		      <td>
		      	...
		      	<c:choose>
					...
					<c:otherwise>
						<a class="btn btn-primary" href="ServletListClient?idType=1&idClient=<c:out value="${idClient }"></c:out>">Créer</a>
					</c:otherwise>
				</c:choose>
		    ...
		    <tr>
		      ...
		      <td>
		      	<c:choose>
					<c:when test="${ce.dateCreation != null }">
						<c:out value="${ce.numCompte }"></c:out>
					</c:when>
					<c:otherwise>
						<c:out value=""></c:out>
					</c:otherwise>
		      ...
		      <td>
		      	<c:choose>
					<c:when test="${ce.dateCreation != null }">
						<c:out value="${ce.solde }"></c:out>
					</c:when>
					<c:otherwise>
						<a class="btn btn-primary" href="ServletListClient?idType=2&idClient=<c:out value="${idClient }"></c:out>">Créer</a>
					</c:otherwise>
				</c:choose>
		      </td>
		    </tr>
